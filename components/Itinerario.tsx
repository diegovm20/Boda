  ...
  return (
    ...
    >
      <div className="section relative">
        ...
        {/* El ramo asoma por fuera de la tarjeta, así que vive en este wrapper:
            la tarjeta recorta su contenido (overflow-hidden) y lo taparía. */}
        <div className="relative mx-auto">
          <Image
            ...
            height={864}
            sizes="160px"
            className="pointer-events-none absolute -left-4 -top-12 z-20 w-24 -rotate-6 select-none sm:-left-8 sm:-top-16 sm:w-32"
            data-reveal
          />

          {/* Panel de vidrio con los dos eventos agrupados */}
          <div
            className="glass relative overflow-hidden rounded-[1.75rem] px-6 py-10 sm:px-10"
            data-reveal
          >
